...
class SettingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Merchant.setting.list', [
           'list'=>$result
        ]);
    }
    ...
    */
    public function add(Request $request)
    {
        ...
        return view('Merchant.setting.add', [
    ...
    public function modify(Request $request){
        ...
        return view('Merchant.setting.modify',[
            'info' => $setting
        ]);
    }
    ...
    public function delete(Request $request){
        ...
        if(SettingModel::where('id',$id)->update(['disabled'=>1])){
            return $this->response(200,'删除成功！',route('business.setting.list'));
        }else{
