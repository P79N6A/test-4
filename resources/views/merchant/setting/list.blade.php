            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ route('business.setting.add') }}" class="btn btn-primary btn-xs">新增基本设置</a>
                    </div>
                </div>
                            ...
                            @if(!empty($list))
                                @foreach($list as $item)
                                    <tr>
                                        ...
                                        <td>{{$item->value}}</td>
                                        <td>
                                            <a href="{{ route('business.setting.modify',['id'=>$item->id]) }}"
                                               class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> 修改 </a>
                                            <a href="javascript:;" data-url="{{ route('business.setting.delete') }}"
