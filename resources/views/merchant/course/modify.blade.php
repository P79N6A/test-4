                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control m-b" name="type_id">
                                            ...
                                            <option @if($info->type_id == $v->id) checked @endif value="{{$v->id}}">{{$v->name}}</option>
                                            @endforeach
                                            @else
                                            <option>暂无选项</option>
                                            @endif
                                    ...
                                    <div class="form-group store">
                                        ...
                                        <label class="checkbox-inline i-checks" for="store_[{{$store->id}}]">
                                            <input @if(in_array($store->id,$store_ids)) checked @endif type="checkbox" id="store_[{{$store->id}}]" name="store_ids[]" value="{{$store->id}}">{{$store->name}}
                                        </label>
                                        @endforeach
                                        @endif
                                    </div>
