...
@section('main')
            ...
            <div class="col-sm-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <form action="{{ route('merchant.edit-store') }}" class="forms" method="post">
                                {{ csrf_field() }}
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label>门店名称</label>
                                        <input type="text" name="name" value="{{$info->name}}" placeholder="" class="form-control">
                                        <input type="text" name="id"  value="{{$info->id}}">
                                    </div>
                                    <div class="form-group">
                                        <label>电话</label>
                                        <input type="text" name="tel" value="{{$info->tel}}" placeholder="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>城市</label>
                                    ...
                                    <div class="form-group" >
                                        <label>门店地址</label>
                                        <input type="text" name="address" value="{{$info->address}}" id="address" placeholder="" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label>门店维度</label>
                                        <input type="text" name="latitude" value="{{$info->latitude}}" id="latitude"  placeholder="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>门店经度</label>
                                        <input type="text" name="longitude" value="{{$info->longitude}}" id="longitude" placeholder="" class="form-control">
                                    </div>  
                                    <!-- <div class="form-group">
                                        <label>门店老师</label>
    ...
    <script src="https://webapi.amap.com/maps?v=1.4.8&key=b8d6cd405dd2af2cdaf9a624a576aae6&plugin=AMap.Geocoder&plugin=AMap.Autocomplete"></script>
