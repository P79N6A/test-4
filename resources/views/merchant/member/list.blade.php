            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                            ...
                            <form role="form" class="form-inline" action="{{ route('business.member-list') }}" method="get">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    @if ($member->role === 1)
                                                        <li>
                                                            <a href="javascript:;" data-url="{{ route('business.set-doctor') }}"
                                                    ...
                                                    @if ($member->role === 3)
                                                        <li>
                                                            <a href="javascript:;" data-url="{{ route('business.store.unbindStaff') }}"
                                                            data-type="id" data-id="{{ $member->id }}"
                                                    ...
                                                    @endif
                                                    <li>
                                                        <a href="{{ route('business.edit-member',['id'=>$member->id]) }}"
                                                    class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> 修改 </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;" data-url="{{ route('business.delete-member') }}"
                                                    data-type="id" data-id="{{ $member->id }}"
