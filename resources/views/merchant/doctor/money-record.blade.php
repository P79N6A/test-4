                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="javascript:;" data-url="{{ route('business.doctor-money-operate') }}" data-type="id" data-id="{{ $money->id }}" data-usersId="{{$usersId}}"
                                                        class="btn btn-success btn-sm approve"><i class="fa fa-check"></i> 审核通过</a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;" data-url="{{ route('business.doctor-money-operate') }}"
