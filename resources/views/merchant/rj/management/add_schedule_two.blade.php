...
ul,ol{list-style: none;}
			...
			{{ csrf_field() }}
        		...
        		<?php foreach($scduhele_list as $key=>$val){  $i++; ?>
		        	<div class="z_mb10  posr border_padding">
						...
						<div class="z_inputbox z_mb10 clearfix">
							<label class="z_lineh34 fl z_mr15 z_w100 tr"><span class="z_color_red">*</span>创建团队:</label>
							<span class="z_cursor js-addjixing_team fl" data-value="0"  data-team="0" >
	        					<img src="/admin/img/u294.png" width="29" height="29"/>
	        				</span>
						</div>

						<div class=" js-team " style=""  >
                            <?php foreach($val['team'] as $t_key=>$t_val){ ?>
								<div class="team" data-team="{{$t_key}}" >
									<div class="z_inputbox z_mt10 z_mb10 clearfix">
										<label class="z_lineh34 fl z_mr15 z_w100 tr "><span class="z_color_red">*</span>团队名称:</label>
										<input type="text" class="z_w120 form-control"  name="data[{{$key}}][team][{{$t_key}}][game_name]" value="{{$t_val['team_name']}}">
									</div>
									<div class="z_inputbox z_mb10 clearfix">
										<label class="z_lineh34 fl z_mr15 z_w100 tr"><span class="z_color_red">*</span>选择机台:</label>
										<span class="z_cursor js-addjixing fl" data-value="{{$key}}" data-team="{{$t_key}}" >
											<img src="/admin/img/u294.png" width="29" height="29"/>
										</span>
									</div>
									<div class="z_border  z_mb20 margin_left_25 js-table">
										<table class="z_table2 js-z_table2 ">
											...
											<tbody data-value="{{$key}}" data-team="{{$t_key}}" >
											@if(!empty($t_val['m_id']))
												<?php foreach($t_val['m_id'] as $m_key=>$m_val){ ?>
												<tr>
													...
													<td>
														...
														<input type="hidden" name="data[{{$key}}][team][{{$t_key}}][machine_id][]" value="{{$m_val['m_id']}}">
		        	...
		        	<div class="z_mb10  posr border_padding">
						...
						<div class=" js-team " style=""  >
							<div class="team" data-team="0" >
								<div class="z_inputbox z_mt10 z_mb10 clearfix">
									<label class="z_lineh34 fl z_mr15 z_w100 tr "><span class="z_color_red">*</span>团队名称:</label>
									<input type="text" class="z_w120 form-control"  name="data[0][team][0][game_name]">
								</div>

								<div class="z_inputbox z_mb10 clearfix">
									<label class="z_lineh34 fl z_mr15 z_w100 tr"><span class="z_color_red">*</span>选择机台:</label>
									<span class="z_cursor js-addjixing fl" data-value="0" data-team="0" >
										<img src="/admin/img/u294.png" width="29" height="29"/>
									</span>
								</div>
								<div class="z_border  z_mb20 margin_left_25 js-table">
									<table class="z_table2 js-z_table2 " data="123456">
										<thead>
											<tr>
												<th class="" >门店</th>
												<th class="" >机台型号</th>
										...
										<tbody data-value="0" data-team="0">
											<!-- 机台列表 -->
										</tbody>
									</table>
								</div>
  ...
  <script  id="team_html" type="text/html">
	  <div class="team" data-team="<!--{team_key}-->" >
		  <div class="z_inputbox z_mt10 z_mb10 clearfix">
			  <label class="z_lineh34 fl z_mr15 z_w100 tr "><span class="z_color_red">*</span>团队名称:</label>
			  <input type="text" class="z_w120 form-control"  name="data[<!--{key}-->][team][<!--{team_key}-->][game_name]">
		  </div>
		  <div class="z_inputbox z_mb10 clearfix">
			  <label class="z_lineh34 fl z_mr15 z_w100 tr"><span class="z_color_red">*</span>添加机台:</label>
			  <span class="z_cursor js-addjixing fl"  data-value="<!--{key}-->" data-team="<!--{team_key}-->">
				  <img src="/admin/img/u294.png" width="29" height="29"/>
			  </span>
		  </div>
		  <div class="z_border  z_mb20 margin_left_25 js-table">
			  <table class="z_table2 js-z_table2 ">
				  ...
				  <tbody data-value="<!--{key}-->" data-team="<!--{team_key}-->" >
				  <!-- 机台列表 -->
				  </tbody>
			  </table>
		  </div>
  ...
  <script  id="schedule_html" type="text/html">
		<div class="z_mb10  posr border_padding">
			...
			<div class="z_inputbox z_mb10 clearfix">
				<label class="z_lineh34 fl z_mr15 z_w100 tr">
					<span class="z_color_red">*</span>创建团队:
				</label>
					<span class="z_cursor js-addjixing_team fl" data-value="<!--{key}-->"  data-team="0">
					<img src="/admin/img/u294.png" width="29" height="29"/>
					</span>
			</div>
			...
			<div class=" js-team " style="">
					<div class="team" data-team="0">
						<div class="z_inputbox z_mt10 z_mb10 clearfix">
							<label class="z_lineh34 fl z_mr15 z_w100 tr "><span class="z_color_red">*</span>团队名称:</label>
							<input type="text" class="z_w120 form-control"  name="data[<!--{key}-->][team][0][game_name]">
						</div>

						<div class="z_inputbox z_mb10 clearfix">
							<label class="z_lineh34 fl z_mr15 z_w100 tr"><span class="z_color_red">*</span>添加机台:</label>
							<span class="z_cursor js-addjixing fl"  data-value="<!--{key}-->" data-team="0">
								<img src="/admin/img/u294.png" width="29" height="29"/>
							</span>
						</div>
						<div class="z_border  z_mb20 margin_left_25 js-table">
							<table class="z_table2 js-z_table2 ">
								...
								<tbody data-value="<!--{key}-->" data-team="0">
								<!-- 机台列表 -->
								</tbody>
							</table>
						</div>
...
<!--{each list as val}-->
	 <tr>
		...
		<td> 
			<span class="btn btn-white btn-sm z_color_red" onclick="del(this)">删除</span> 
			<input type="hidden" name="data[<!--{key}-->][team][<!--{team_key}-->][machine_id][]" value="<!--{val.m_id}-->">
		</td>
	</tr>
<!--{/each}-->
 </script>
  ...
  <script>
	...
	//				layer.msg(res.msg,{icon:1});
		...
		$("body").delegate(".js-addjixing",'click',function(){
            ...
            var team_num = $(this).attr('data-team');
			console.log(schedule_num);
	// size();
			//获取当前赛程已经添加的机台id ( 查询  not in  )
//			var strID='';
//			$('input[name="data['+schedule_num+'][team]['+team_num+'][machine_id][]"]').each(function(){
//				strID+= $(this).val()+',';
//			});
//			console.log('获取当前赛程已经添加的机台id '+strID);

            var strID='';
            $(this).parent().parent().parent().children('.team').each(function(){
                console.log('.team');
				//这里的$(this)为 .team
                $(this).find('.js-table').find('table').find('tbody').children('tr').each(function(){
                 //   console.log();
                    //这里的$(this)为 tr
                    strID+= $(this).find('input[type="hidden"]').val()+',';
				});
			});
            console.log('获取当前赛程已经添加的机台id '+strID);

			$('.js-z_table2_add').attr('data-schedule_num',schedule_num);	//传递当前赛程
            $('.js-z_table2_add').attr('data-team_num',team_num);	//传递当前团队
					...
					console.log('schedule_num'+schedule_num);
						//插入
						 $('.js-z_table2').children('tbody').each(function(){
							 ...
							 var team_val = $(this).attr('data-team');
							 console.log('_val'+_val);
							 console.log(team_val);
							 if(_val==schedule_num){
							     if(team_val==team_num){
                                     $(this).append(html);
								 }
							 }
	...
	//			console.log(prize_key);
        ...
        //添加团队
        $('body').delegate(".js-addjixing_team",'click',function(){
            //获取当前赛程下标
            var schedule_num = $(this).attr('data-value');
            			console.log(schedule_num);
			var team_num = $(this).attr('data-team');
            	team_num = parseInt(team_num);
				$(this).attr('data-team',team_num+1);

            data = {'key':schedule_num,'team_key':team_num+1};
            var html =template('team_html',data);
            	console.log(html);
          //  	layer.alert(html);
