...
@section('main')
	...
	<div class="row" >
		<form id="form1" action="{{route('business.rj_yun_add')}}" method="post">
		{{ csrf_field() }}
		<!--创建赛程-->
			...
			<div class="z_mb10  posr border_padding">
				...
				<div class="z_inputbox z_mt10 z_mb10 clearfix">
					...
					<input type="text" class="z_w200 form-control"  name="name" value="" placeholder="活动名称" >
				</div>
				<div class="z_inputbox z_mt10 z_mb10 clearfix">
					<label class="z_lineh34 fl z_mr15 z_w100 tr "><span class="z_color_red">*</span>活动规则:</label>
					<textarea rows="3" cols="20"  class="z_w200 form-control" name="rule" placeholder="请输入活动规则" ></textarea>
				</div>
	...
	<script id="listTwo"  type="text/html">
		<tr>
			<td>
				<select class="z_w120 input-sm form-control input-s-sm inline prize_value" name="data[prize][<!--{prize_key}-->][option]" onchange='btnChange(this);'>
					{{--<option value="3">积分</option>--}}
	...
	<script type="text/javascript">
        ...
        var get_start = {
            ...
            choose: function(datas) {
                get_end.start = datas //将结束日的初始值设定为开始日
            }
        };
        laydate(get_start);
        var get_end = {
            ...
            istoday: false,
            choose: function(datas) {
                get_start.max = datas; //结束日选好后，重置开始日的最大日期
            }
        };
        laydate(get_end);
