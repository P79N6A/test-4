...
@section('main')
	...
	<div class="row" >
		<form id="form1" action="{{route('admin.rj_yun_add')}}" method="post">
		{{ csrf_field() }}
		<!--创建赛程-->
			...
			<div class="z_mb10  posr border_padding">
				<div class="z_inputbox z_mt10 z_mb10 clearfix">
					<label class="z_lineh34 fl z_mr15 z_w100 tr "><span class="z_color_red">*</span>积分模式:</label>
					<select class="z_w120 input-sm form-control input-s-sm inline prize_value" name="game_type" onchange='gameType(this);'>
						<option value="1" >固定积分模式</option>
						<option value="2" >积分累计模式</option>
					</select>
				</div>
				<div class="z_inputbox z_mt10 z_mb10 clearfix">
					<label class="z_lineh34 fl z_mr15 z_w100 tr "><span class="z_color_red">*</span>活动名称:</label>
					<input type="text" class="z_w120 form-control"  name="name" value="" placeholder="请输入名称" >
				</div>
				...
				<div class="game_type_one"><!--固定模式-->
					...
					<div class="border_padding z_mb10 lottery_type_1">
						<div class="z_inputbox z_mt10 z_mb10 clearfix ">
							<label class="z_w120-tr z_mr10 z_fontb">开奖周期:</label>
							<label class="z_mr10">
								<input type="radio" name="lottery_cycle" value="1" checked="" >日
							</label>
							<label class="z_mr10">
								<input type="radio" name="lottery_cycle" value="2">周
							</label>
							<label class="z_mr10">
								<input type="radio" name="lottery_cycle" value="3">月
							</label>
						</div>
						<div class="z_inputbox z_mt10 z_mb10 clearfix ">
							<label class="z_w120-tr z_mr10 z_fontb fl">奖励次数:</label>
							<input type="number" class="z_w120 form-control" name="total_awards[0]" value="0">
						</div>
						<div class="z_inputbox z_mt10 z_mb10 clearfix ">
							<label class="z_w120-tr z_mr10 z_fontb fl">活动开始时间:</label>
							<input type="text" class="z_w200 form-control" name="start_time_one[0]" id="get_start_one" value="" placeholder="请选择开始时间">
						</div>
					</div>
					<div class="border_padding z_mb10 lottery_type_2 hide ">
						<div class="z_inputbox z_mt10 z_mb10 clearfix ">
							<label class="z_w120-tr z_mr10 z_fontb fl">自定义活动时间:</label>
							<input type="text"  class="z_w200 form-control fl" name="start_time" id="get_start" value="" placeholder="请选择开始时间">
							<span class="fl">至</span>
							<input type="text"  class="z_w200 form-control " name="end_time" id="get_end" value="" placeholder="请选择结束时间">
						</div>
					</div>
				</div>
				<div class="game_type_two hide">
					<div class="z_inputbox z_mt10 z_mb10 clearfix ">
						<label class="z_w120-tr z_mr10 z_fontb fl">奖励次数:</label>
						<input type="number" class="z_w120 form-control" name="total_awards[1]" value="0">
					</div>
					<div class="z_inputbox z_mt10 z_mb10 clearfix ">
						<label class="z_w120-tr z_mr10 z_fontb fl">活动开始时间:</label>
						<input type="text" class="z_w200 form-control" name="start_time_one[1]" id="get_start_two" value="" placeholder="请选择开始时间">
					</div>
					<div class="z_inputbox z_mt10 z_mb10 clearfix ">
						<label class="z_w120-tr z_mr10 z_fontb fl">云积分初始值:</label>
						<input type="number" class="z_w120 form-control" name="initial" value="0">
					</div>
					<div class="z_inputbox z_mt10 z_mb10 clearfix ">
						<label class="z_w120-tr z_mr10 z_fontb fl">云积分增值:</label>
						<input type="number" class="z_w120 form-control" name="increase" value="0">
					</div>
					<div class="z_inputbox z_mt10 z_mb10 clearfix ">
						<label class="z_w120-tr z_mr10 z_fontb fl">云积分增值币数:</label>
						<input type="number" class="z_w120 form-control" name="coin" value="0">
					</div>
					<div class="z_inputbox z_mt10 z_mb10 clearfix ">
						<label class="z_w120-tr z_mr10 z_fontb fl">云积分封顶值:</label>
						<input type="number" class="z_w120 form-control" name="cap" value="0">
					</div>
				</div>
				...
				<div class="  z_mb20 margin_left_50 js-z_store">
					<!--  门店示例模板
                        <div class="clearfix z_pb10 brand_store_id_0" >
                            <span class="fl z_ptb5"> 大玩家：</span>
                            <div class="fl z_border z_ml10 z_border_ra-5" style="padding: 5px 2px;">
                                门店1 <span class="z_color_red del_id" style="cursor:pointer ">X</span>
                                <input type="hidden" name="select_store_id[]" value="1">
                            </div>
                        </div>
                    -->
				</div>
				...
				<div class="  z_mb20 margin_left_50 ">
					<div class="clearfix z_pb10 js-z_table2">
						<!--  机台示例模板
                            <div class="fl z_border z_ml10 z_border_ra-5" style="padding: 5px 2px;">
                                机台1 <span class="z_color_red del_id" style="cursor:pointer ">X</span>
                                <input type="hidden" name="select_machine_id[]" value="">
                            </div>
                         -->
					</div>
				</div>
				...
				<div class="z_border z_mb20 margin_left_50">
					<table class="z_table2 js-z_table2a">
						...
						<tr>
							<td>
								<select class="z_w120 input-sm form-control input-s-sm inline prize_value" name="data[prize][0][option]" onchange='btnChange(this);'>
									<option value="1" >线下礼品</option>
									<option value="2" >奖票</option>
									<option value="3"  selected  >积分</option>
								</select>
							</td>
							<td><input type="text" class="z_w100 z_mr10" name="data[prize][0][name]" value="积分" ></td>
							<td>
								<div class=" z_mtb10 z_mlrauto gallery-picker  hide " data-value="1232342131" >
									<div class="bgwh">
										上传<input type="hidden" name="data[prize][0][pic]" value="" />
									</div>
								</div>
								<div  style="position: relative;" class=" ">
									<img class="z_fix_img z_mtb10 z_mlrauto" src="">
									<span class="z_off js-z_off"></span>
								</div>
							</td>
							<td><input type="text" name="data[prize][0][num]" value="1" ></td>
							<td>
								<div class="bar-white z_border " style="width: 120px; background:#fff;     margin: 0 auto; ">
									<input  value="1"
											name="data[prize][0][ranking]"
	...
	<script>
        function addstore_ajax(data){
            ...
            $.post('{{route("admin.rj_yun_storeLists")}}',data,function(res){
                if(res.code=='200'){
                    data={'list':res.data};
        ...
        $('body').delegate('.js-z_store_add','click',function(){
            ...
            $.post('{{route("admin.rj_yun_brand_store")}}',{'arr_store_id':strID,'_token':_token},function(res){
                if(res.code=='200'){
                    var _data = res.data;
	...
	<script type="text/javascript">
        function machint_ajax(m_name){
         ...
         //   selectID = '3099,3454,3589,';
            ...
            $.post('{{route("admin.rj_yun_machine_list")}}',data,function(res){
                if(res.code=='200'){
                    data={'list':res.data};
