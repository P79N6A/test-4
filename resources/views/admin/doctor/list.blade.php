        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <form action="{{ route('admin.doctor-list') }}" method="get">
                            ...
                            @if(!empty($members))
                                @foreach($members as $member)
                                    <tr>
                                        ...
                                        <td>{{ $member->mobile }}</td>
                                        <!-- <th><a href="{{ route('admin.doctor-money-list',['usersId'=>$member->id]) }}">{{ $member->money }}</a></th> -->
                                        <!-- <th><a href="{{ route('admin.doctor-record-list',['usersId'=>$member->id]) }}">{{ $member->record_amount }}</a></th> -->
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <!-- <li>
                                                        <a href="javascript:;" data-url="{{ route('admin.set-commission-rate') }}" data-type="id" data-id="{{ $member->id }}" 
                                                    ...
                                                    <li>
                                                        <a href="{{ route('admin.edit-doctor',['id'=>$member->id]) }}"
                                                    class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> 修改 </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;" data-url="{{ route('admin.delete-doctor') }}"
                                                    data-type="id" data-id="{{ $member->id }}"
