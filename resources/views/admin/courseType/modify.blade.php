            ...
            <div class="col-sm-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <form action="{{ route('admin.course.type.modify') }}" class="forms">
                                {{ csrf_field() }}
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio i-checks">
                                            <label>
                                                <input type="radio" @if($info->disabled == 0) checked="" @endif value="0" name="disabled">
                                                <i></i> 否
                                            </label>
                                            <label>
                                                <input type="radio" value="1" name="disabled" @if($info->disabled == 1) checked="" @endif >
                                                <i></i> 是
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="ibox-content no-padding border-left-right image-preview" style="margin-top:10px">
                                                <img src="{{$info->img->path or '1'}}" width="100" height="auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
