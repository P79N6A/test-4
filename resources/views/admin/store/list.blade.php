                            ...
                            @if(!empty($list))
                                @foreach($list as $item)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ route('admin.course.list',['store_id'=>$item->id]) }}">查看</a>
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.equipment.list',['store_id'=>$item->id]) }}">查看</a>
                                        </td>
                                        <td>
                                            -
                                        </td>
                                        <td>
                                        <a href="{{ route('admin.member-list',['store_id'=>$item->id]) }}">查看</a>
                                        </td>
                                        <td>
                                            {{$item->created_at}}
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.business.store.modify',['id'=>$item->id]) }}" class="btn btn-warning btn-sm">
                                               <i class="fa fa-pencil"></i> 修改
                                            </a>
                                            <a class="btn btn-primary btn-sm" href="{{ route('admin.business.store.bindStaff',['id'=>$item->id]) }}">
