    ...
    <div class="col-sm-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                <div class="row">
                    <form action="{{ route('admin.ads.add') }}" class="forms">
                        {{ csrf_field() }}
                        <div class="col-sm-8">
    ...
    $(document).ready(function() {
        ...
        imageUploader.on('uploadSuccess', function(file, response) {
            ...
            if (response.msg[0]) {
                ...
                $('.image-preview').empty().append($('<img class="img-preview-sm">').attr('src',
                    response.data[0].absolute_path).css({
                    width: 160,
                    height: 90
                }));
