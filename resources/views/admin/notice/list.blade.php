            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ route('admin.notice.add') }}" class="btn btn-primary btn-xs">发布通知</a>
                    </div>
                </div>
                            ...
                            @if(!empty($list))
                                @foreach($list as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.notice.modify',['id'=>$item->id]) }}"
                                               class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> 修改 </a>
                                            <a href="javascript:;" data-url="{{ route('admin.notice.delete') }}"
