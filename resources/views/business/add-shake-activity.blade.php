        ...
        <div class="col-sm-8">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <form action="{{ route('business.add-shake-activity') }}" method="post" class="form-add-shake">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <div class="form-group discount-container">
                                    <label>中奖限制次数</label>
                                    <input type="number" name="win_limit" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>举办门店</label>
                                    <div>
