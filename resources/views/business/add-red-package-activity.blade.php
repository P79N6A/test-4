            ...
            <div class="col-sm-8">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form action="{{ route('business.add-red-package-activity') }}" method="post" class="form-add">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label>有效期</label>
                                        <div>
                                            <input placeholder="开始时间" name="start_date" class="form-control layer-date" id="start_date">
                                            <input placeholder="结束时间" name="end_date" class="form-control layer-date" id="end_date">
                                        </div>
                                    </div>
                            ...
                            <button class="btn btn-sm btn-primary btn-add" type="submit">保存</button>
                        </form>
                    </div>
                </div>
            </div>
