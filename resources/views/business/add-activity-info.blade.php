        ...
        <div class="col-sm-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <form action="{{ route('business.add-activity-info') }}" method="post" class="add-info">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-7">
                                    ...
                                    <div>
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" name="push_flag" value="1" class="onoffswitch-checkbox" id="rec1">
                        ...
                        <button class="btn btn-sm btn-primary btn-add-info" type="button">创建资讯</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        */
        ...
        $('.btn-add-info').click(function(){
            youyibao.httpSend($('form.add-info'),'post',1);
        });
    });
    </script>
@endsection
