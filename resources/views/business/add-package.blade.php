        ...
        <div class="col-sm-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <form action="/add-package" method="post" class="form-add-package">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-5">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="input-group clockpicker" data-autoclose="true">
                                                    ...
                                                    <input type="text" class="form-control" name="expire_time">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs">
                                            <li class="tab active tab-switch" data-id="1"><a data-toggle="tab" href="#tab-1" aria-expanded="true">游戏币</a></li>
                                            <li class="tab tab-switch" data-id="2"><a data-toggle="tab" href="#tab-2" aria-expanded="true">门票</a></li>
                                        ...
                                        <div class="tab-content">
                                            <div id="tab-1" class="tab-pane active">
                                                <div class="panel-body">
                                                    <div class="form-group">
                                                        <input name="coins" class="form-control" placeholder="出币数">
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="tab-2" class="tab-pane">
                                                <div class="panel-body">
                                                    <div class="form-group">
                                                        <input name="ticket_name" class="form-control" placeholder="门票名称，最长10个中文">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    @foreach($stores as $k=>$store)
                                        <label class="checkbox-inline i-checks" for="store_[{{ $k }}]">
                                            <input type="checkbox" id="store_[{{ $k }}]" name="store_ids[]" value="{{ $store->id }}">{{ $store->name }}
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <button class="btn btn-sm btn-primary btn-add-package" type="button">创建套餐</button>
                    </form>
                </div>
            </div>
        </div>
