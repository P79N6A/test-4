            ...
            <div class="col-sm-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <form action="/edit-user" class="form-edit-user">
                                {{ csrf_field() }}
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label>操作员描述</label>
                                        <textarea class="form-control" name="description" placeholder="可选">{{ $user->description }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>密码</label>
                        ...
                        <button class="btn btn-sm btn-primary btn-edit-user" type="submit">修改</button>
                    </div>
                </div>
            </div>
        </div>
